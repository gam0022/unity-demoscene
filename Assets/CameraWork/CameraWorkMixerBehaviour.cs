...
public class CameraWorkMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        {
            ScriptPlayable<CameraWorkBehaviour> playableInput = (ScriptPlayable<CameraWorkBehaviour>)playable.GetInput (i);
            CameraWorkBehaviour input = playableInput.GetBehaviour ();
