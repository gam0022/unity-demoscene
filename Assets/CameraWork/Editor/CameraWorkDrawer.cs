...
[CustomPropertyDrawer(typeof(CameraWorkBehaviour))]
public class CameraWorkDrawer : PropertyDrawer
{
    ...
    {
        int fieldCount = property.FindPropertyRelative ("tweenType").enumValueIndex == (int)CameraWorkBehaviour.TweenType.Custom ? 5 : 3;
    ...
    public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (tweenTypeProp.enumValueIndex == (int)CameraWorkBehaviour.TweenType.Custom)
        {
